...
export const propertySchema = z.object({
    ...
    publicTitle: z.string().max(200).trim().nullable().optional(),
    publicSubtitle: z.string().max(200).trim().nullable().optional(),
    shortDescription: z.string().max(500).trim().nullable().optional(),
    fullDescription: z.string().max(10000).trim().nullable().optional(),
    ...
    buildingFloors: z.number().int().nonnegative().nullable().optional(),
    floorNumber: z.number().int().nonnegative().nullable().optional(),
    constructionYear: z.number().int().nullable().optional(),
    propertySize: z.number().nullable().optional(),
    propertySizeUnit: z.string().nullable().optional(),
