                ...
                <Card className="max-w-xl mx-auto shadow-2xl rounded-[2rem] overflow-hidden border-0">
                    <div className="bg-olive-900 p-8 text-center text-white relative">
                        <div className="absolute top-6 left-8 bg-white rounded-xl p-1.5 shadow-lg">
                            <Image src="/imagens/logo.png?v=4" alt="Logo" width={40} height={40} className="object-contain" />
                        </div>
    ...
    return (
        <div className="min-h-screen bg-sand-50 py-12 px-4 bg-[url('/imagens/pattern.png')] bg-repeat">
            <div className="max-w-5xl mx-auto mb-8 flex justify-center lg:justify-start">
                <Link href="/">
                    <Image src="/imagens/logo.png?v=4" alt="Casa Oliveira" width={150} height={50} className="object-contain hover:opacity-80 transition-opacity" />
                </Link>
            </div>
                        ...
                        <div className="aspect-video relative overflow-hidden bg-olive-900/5">
                            {propertyData?.photos?.[0]?.imageUrl ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-olive-900/10">
                                    <Image src="/imagens/logo.png?v=4" alt="Logo" width={80} height={80} className="opacity-20 object-contain" />
                                </div>
                            )}
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center bg-olive-900/5 p-4 rounded-xl">
                                    <div>
                                        ...
                                        <p className="font-bold text-sm tracking-tight text-olive-900">
                                            {checkIn ? new Date(checkIn + "T00:00:00").toLocaleDateString('pt-BR') : "--/--/----"}
                                        </p>
                                        <p className="text-[10px] text-olive-900/60 font-medium">
                                            {propertyData?.checkInStart === "Flexível"
                                                ? "Horário flexível"
                                                : propertyData?.checkInStart
                                                    ? `Entre ${propertyData.checkInStart} e ${propertyData.checkInEnd === "Flexível" ? "a combinar" : (propertyData.checkInEnd || "...")}${propertyData.checkInEnd?.includes("01") || propertyData.checkInEnd?.includes("02") || propertyData.checkInEnd?.includes("03") ? " (dia seguinte)" : ""}`
                                                    : "..."}
                                        </p>
                                    </div>
