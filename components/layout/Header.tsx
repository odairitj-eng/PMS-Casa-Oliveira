...
export function Header() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu Drawer - Outside of header to avoid stacking context issues */}
            <div className={cn(
                "fixed inset-0 z-[999] bg-[#F5EBE1] transition-all duration-500 md:hidden flex flex-col",
                ...
                <div className="p-6 flex justify-between items-center border-b border-olive-900/10 bg-white/40">
                    ...
                    <button
                        ...
                        className="p-3 bg-olive-900/5 rounded-2xl text-olive-900 active:scale-90 transition-transform"
                    >
                        <X className="w-6 h-6" />
                    </button>
                </div>

                <div className="flex-1 overflow-y-auto pt-16 pb-32 px-10 flex flex-col gap-12">
                    <Link
                        href="#a-casa"
                        onClick={(e) => handleScroll(e, 'a-casa')}
                        className="text-4xl font-black text-olive-900 tracking-tight transition-transform active:scale-95 origin-left"
                    >
                        A Casa
                    </Link>
                    <Link
                    ...
                    <div className="mt-6 pt-10 border-t border-olive-900/10 flex flex-col gap-4">
                        <p className="text-xs font-bold text-olive-900/30 uppercase tracking-[0.2em]">Entre em Contato</p>
                        <a href="tel:+5547999820528" className="text-2xl font-black text-olive-900 tracking-tighter transition-opacity active:opacity-60">+55 47 99982-0528</a>
                    </div>
                </div>
            </div>
        </>
